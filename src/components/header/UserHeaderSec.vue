...
const menuList = ref<IMenu[]>([
  ...
  },
  {
    ...
    children: [
      ...
      //   // TODO: 비전기술, 음성기술 url 받아서 menuUrl에 적용 필요
      //   children: [
      //     {
...
<template>
  <header class="header header--purple">
    <h1 @click="moveHomePage">
      <Icon name="logo--fff" width="158" height="38" alt="ixi Solution" />
    </h1>
    <el-menu mode="horizontal" :ellipsis="false" :popper-offset="0" class="el-menu--purple">
      <template v-for="menu in menuList" :key="`user-sidebar-${menu.menuId}`">
        <!-- 메뉴가 여러 뎁스로 있는 경우 사용 -->
        <el-sub-menu v-if="menu.children" :index="menu.menuIndex" popper-class="header-menu--purple">
          <template #title>
            <!-- TODO: icon 필요할때 사용 -->
